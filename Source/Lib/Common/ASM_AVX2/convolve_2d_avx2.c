...
static void convolve_2d_sr_hor_6tap_avx2(const uint8_t *const src, const int32_t src_stride,
    ...
    if (w == 8) {
        do {
            ...
            #else
            const __m256i res = x_convolve_6tap_8x2_avx2_vnni(src_ptr, src_stride, coeffs_256, filt_256);
            #endif
        ...
        do {
            ...
            #else
            xy_x_6tap_32_avx2_vnni(src_ptr, coeffs_256, filt_256, im);
            #endif
            src_ptr += src_stride;
            im += 32;
        } while (--y);
        ...
        do {
            ...
            #else
            xy_x_6tap_32_avx2_vnni(src_ptr, coeffs_256, filt_256, im);
            xy_x_6tap_32_avx2_vnni(src_ptr + 32, coeffs_256, filt_256, im + 32);
            #endif
            src_ptr += src_stride;
            im += 64;
        } while (--y);
        ...
        do {
            ...
            xy_x_6tap_32_avx2_vnni(src_ptr, coeffs_256, filt_256, im);
            xy_x_6tap_32_avx2_vnni(src_ptr + 32, coeffs_256, filt_256, im + 32);
            xy_x_6tap_32_avx2_vnni(src_ptr + 64, coeffs_256, filt_256, im + 64);
            xy_x_6tap_32_avx2_vnni(src_ptr + 96, coeffs_256, filt_256, im + 96);
            #endif
            src_ptr += src_stride;
            im += 128;
        } while (--y);
...
static void convolve_2d_sr_hor_8tap_avx2(const uint8_t *const src, const int32_t src_stride,
    ...
    if (w == 8) {
        do {
            ...
            #else
            const __m256i res = x_convolve_8tap_8x2_avx2_vnni(src_ptr, src_stride, coeffs_256, filt_256); // !!!!!!!!!!!!!!!!!
            #endif
            xy_x_round_store_8x2_avx2(res, im);
            src_ptr += 2 * src_stride;
            im += 2 * 8;
        ...
        do {
            ...
            #else   
            xy_x_8tap_32_avx2_vnni(src_ptr, coeffs_256, filt_256, im);
        ...
        do {
            ...
            #else
            xy_x_8tap_32_avx2_vnni(src_ptr, coeffs_256, filt_256, im);
            xy_x_8tap_32_avx2_vnni(src_ptr + 32, coeffs_256, filt_256, im + 32);
            #endif
            src_ptr += src_stride;
            im += 64;
        } while (--y);
        ...
        do {
            ...
            xy_x_8tap_32_avx2_vnni(src_ptr, coeffs_256, filt_256, im);
            xy_x_8tap_32_avx2_vnni(src_ptr + 32, coeffs_256, filt_256, im + 32);
            xy_x_8tap_32_avx2_vnni(src_ptr + 64, coeffs_256, filt_256, im + 64);
            xy_x_8tap_32_avx2_vnni(src_ptr + 96, coeffs_256, filt_256, im + 96);
            #endif
            src_ptr += src_stride;
            im += 128;
        } while (--y);
    ...
    if (w == 2) {
        ...
        if (w == 4) {
            ...
            if (subpel_y_q4 != 8) {
                ...
                do {
                    //#ifndef VNNI_SUPPORT PB
                    xy_y_convolve_6tap_16x2_half_pel_avx2(im, 16, s_256, ss_256, coeffs_256, r);
                    /*#else
                    xy_y_convolve_6tap_16x2_half_pel_avx2_vnni(im, 16, s_256, ss_256, coeffs_256, r);
                    #endif*/
                    xy_y_round_store_16x2_avx2(r, dst, dst_stride);
            ...
            do {
                ...
                do {
                    ...
                    xy_y_convolve_6tap_16x2_avx2(
                        s + 16, w, s_256[1], ss_256[1], tt_256[1], coeffs_256, r1);
                    #else
                    xy_y_convolve_6tap_16x2_avx2_vnni(
                        s, w, s_256[0], ss_256[0], tt_256[0], coeffs_256, r0);
                    xy_y_convolve_6tap_16x2_avx2_vnni(
                        s + 16, w, s_256[1], ss_256[1], tt_256[1], coeffs_256, r1);
                    #endif
        ...
        if (w == 4) {
            ...
            if (subpel_y_q4 != 8) {
                ...
                do {
                    ...
                    /*#else
                    xy_y_convolve_8tap_8x2_half_pel_avx2_vnni(im, coeffs_256, s_256, r);
                    #endif*/
                    xy_y_round_store_8x2_avx2(r, dst, dst_stride);
                    im += 2 * 8;
                    dst += 2 * dst_stride;
            ...
            if (subpel_y_q4 != 8) {
                ...
                do {
                    ...
                    /*#else
                    xy_y_convolve_8tap_16x2_half_pel_avx2_vnni(im, 16, coeffs_256, s_256, r);
                    #endif*/
                    xy_y_round_store_16x2_avx2(r, dst, dst_stride);
            ...
            do {
                ...
                do {
                    ...
                    #else
                    xy_y_convolve_8tap_16x2_avx2_vnni(
                        s, w, coeffs_256, s_256[0], ss_256[0], tt_256[0], r0);
                    xy_y_convolve_8tap_16x2_avx2_vnni(
                        s + 16, w, coeffs_256, s_256[1], ss_256[1], tt_256[1], r1);
                    #endif
